...
[!DNL Insights] _[!UICONTROL 营销活动]_&#x200B;视图显示已连接渠道广告帐户的营销活动列表。

{{connect-insights}}

_[!UICONTROL 营销活动]_&#x200B;表是使用基于渠道的广告营销活动来组织的。 单击表格右侧上方的设置(cog)图标可切换可查看列。

![营销活动筛选器和表](/help/assets/insights-campaigns-filter.png){zoomable="yes"}

当您选择某个促销活动时，[[!UICONTROL 广告]选项卡](published-experiences.md)将打开一个与该促销活动关联的广告名称列表，通过该列表，您可以识别哪些广告促成了促销活动的整体成功。
