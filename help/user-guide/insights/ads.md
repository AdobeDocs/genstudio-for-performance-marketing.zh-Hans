...
| **属性** | 此广告中存在的固有功能列表。 | 有助于识别与受众产生最大共鸣的创意元素。 查看[类别](/help/user-guide/insights/attributes.md#categories)。 |
...
| **属性** | 此广告投放位置中存在的固有功能列表。 | 有助于识别与受众产生最大共鸣的创意元素。 查看[类别](/help/user-guide/insights/attributes.md#categories)。 |
