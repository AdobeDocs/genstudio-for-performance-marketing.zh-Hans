...
| 支持 | 不受支持 |
|----------------------------------|-----------------------------------|
| 动态广告<br>链接广告<br>简单图像广告<br>简单视频广告 | 商店广告<br>Advantage+购物广告<br>Advantage+目录广告<br>轮播广告<br>Messenger广告<br>潜在客户广告<br>集合广告<br>呼叫广告<br>拥有的页面贴文广告<br>合作伙伴广告<br>灵活广告 |

### 广告投放

广告投放位置是指广告在促销活动中出现的特定位置或平台。 这些投放位置决定受众与内容的交互方式和位置。 广告投放扩大了受众范围，这有助于最大限度地提高可见性、参与度和整体促销活动有效性。

在创建包含Meta广告的促销活动时，您可能已根据促销活动[目标](channels.md#objectives)选择了运行广告的位置。
...
\*在[Meta商业帮助中心](https://www.facebook.com/business/help/407108559393196?id=369787570424415)中查看&#x200B;_关于跨Meta技术的广告投放_。
