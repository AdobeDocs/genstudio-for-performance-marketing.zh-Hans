...
要创建横幅体验，请使用可用的模板为内容提供框架。 有关支持的横幅维度的信息，请参阅[模板最佳实践](/help/user-guide/templates/best-practices-for-templates.md#follow-channel-specific-template-guidelines)。
...
![在提示抽屉中输入参数](/help/assets/prompt-displayad2.png){width="50%" align="center"}
