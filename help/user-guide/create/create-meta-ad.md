...
要构建多卡轮播广告而不是单个图像或视频广告，请参阅[创建Meta轮播广告体验](/help/user-guide/create/create-meta-carousel-ad.md)。
...
1. 在&#x200B;_参数_&#x200B;部分中，选择准则 — [!DNL Brands]、[!DNL Personas]和[!DNL Products] — 以通知内容创建。
   ...
   ![选择角色](/help/assets/persona-select-meta2.png){width="50%" align="center"}
