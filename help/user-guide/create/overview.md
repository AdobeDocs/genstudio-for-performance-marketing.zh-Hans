...
* [TikTok广告](tiktok-experiences.md)
* [ChatGPT广告](create-chatgpt-ad.md)
* [已连接的电视广告](create-ctv.md)
...
在&#x200B;_您今天要创建什么内容？_&#x200B;中选择要生成的渠道后 部分中，您可以访问品牌批准的模板以用于内容生成。 使用模板可快速启动内容创建过程，并与定义的品牌标识保持一致。
...
在[!DNL Create]的&#x200B;_最近访问_&#x200B;部分中，您可以访问和管理所有最近草稿。 查看并完成您以前的工作，准备将其发布到[[!DNL Content]](/help/user-guide/content/overview.md)或导出以供使用。 单击选项（三个圆点）图标以删除草稿。
