---
title: TikTok体验
description: 了解如何在Adobe GenStudio for Performance Marketing中创建、审阅、发布和激活TikTok信息源中视频广告。
...
[!DNL GenStudio for Performance Marketing]中的TikTok适合更广泛的全渠道工作流程：您可以在[[!DNL Insights]](/help/user-guide/insights/overview.md#dashboard)中的标准[!DNL Insights]视图（[!UICONTROL 营销活动]、[!UICONTROL 广告]、[!UICONTROL 媒体]和[!UICONTROL 属性]）中分析TikTok营销活动和广告效果，以及其他社交和显示渠道（如Meta和LinkedIn），而不是切换到单独的报表工具。 **[!UICONTROL Insights 2.0]**&#x200B;跨渠道概述（[Insights概述 — Insights 2.0](/help/user-guide/insights/overview.md#insights-20)）仅针对Meta和LinkedIn；当前未包含TikTok。
...
创建工作流中的![TikTok渠道](../../assets/tiktok/create-tiktok-experience.png){width="90%"}
**开始TikTok体验**：
...
1. 输入TikTok标题副本的提示。
1. 单击&#x200B;**[!UICONTROL 生成]**。
   ![Tiktok创建画布控件](../../assets/tiktok/tiktok-prompt.png){width="40%"}
...
![GenStudio发布模式](../../assets/tiktok/publishing-modal.png){width="30%"}

激活表显示最新的激活，处理完成时状态为&#x200B;**Pending**。您可以在发布完成时导航离开。

![TikTok详细信息页面](../../assets/tiktok/tiktok-details-page.png){width="90%"}
