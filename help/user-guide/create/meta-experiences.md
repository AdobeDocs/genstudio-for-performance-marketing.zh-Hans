...
借助Adobe GenStudio for Performance Marketing，您可以使用创作AI来简化[创建高影响力的Meta体验](/help/user-guide/create/create-meta-ad.md)。[!DNL Create] 使内容创建者能够使用[指南](/help/user-guide/guidelines/overview.md)、图像资源和精心编制的提示[来快速[创建Meta广告体验](/help/user-guide/create/create-meta-ad.md)。](/help/user-guide/effective-prompts.md)
