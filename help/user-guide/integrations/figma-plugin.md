...
| ![指示了字段角色的Facebook帖子](./facebook-post.png){width="60%" align="center" zoomable="yes"}<br> | ![指示字段角色的Facebook故事](./facebook-story.png){width="70%" align="center" zoomable="yes"}<br> |
|:---:|:---:|
| ![指示字段角色的Instagram帖子](./instagram-post.png){width="60%" align="center" zoomable="yes"}<br> | ![指示了字段角色的Instagram故事](./instagram-story.png){width="70%" align="center" zoomable="yes"}<br> |
...
![显示字段角色的LinkedIn帖子](./linkedin-ad.png){width="30%" align="center" zoomable="yes"}
...
![字段角色映射](./field-role-mapping.png){width="60%" zoomable="yes"}
...
1. 要迁移选定的帧，请执行下列操作之一：
   ...
   * 单击&#x200B;**[!UICONTROL 传输到Photoshop]**&#x200B;可缓存转换后的文件，以便在GenStudio Photoshop中立即使用。
     ![转移到GenStudio Photoshop按钮](./transfer-to-ps-button.png){width="40%"}
1. 接下来，共享您的Figma文件链接。 插件需要一个Figma文件URL才能完成转换。 添加文档的URL。
...
1. 将出现一个弹出窗口，要求您读取文件的内容和元数据。只需对所有文件执行一次此操作。单击&#x200B;**[!UICONTROL 允许访问]**。
