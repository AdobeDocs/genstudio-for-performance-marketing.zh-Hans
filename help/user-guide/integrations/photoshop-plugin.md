---
title: 适用于Adobe GenStudio for Performance Marketing的GenStudio Photoshop
description: 了解如何安装、配置和使用GenStudio Photoshop for GenStudio for Performance Marketing。
...
# 适用于GenStudio for Performance Marketing的GenStudio Photoshop

GenStudio Photoshop在Adobe Photoshop中添加了一个用于生成品牌内内容的面板。
...
>[!VIDEO](https://video.tv.adobe.com/v/3478830?captions=chi_hans&learn=on)
...
1. 在Adobe Exchange中搜索&#x200B;**GenStudio Photoshop**。
1. 按照提示安装插件。
...
1. 重命名模板类型[&#128279;](../../user-guide/templates/customize-template.md#recognized-field-names)的渠道所需的所有字段的图层。
...
可以将图形框架转换为Photoshop文档并导出以用于GenStudio Photoshop。 要了解如何转换帧，请参阅Figma插件页中的[将Figma帧转换为Photoshop](figma-plugin.md#convert-figma-frames-to-photoshop)部分。
