...
**要将GenStudio for Performance Marketing与您的元帐户连接**：

1. 从&#x200B;_设置_，单击元广告拼贴上的&#x200B;**[!UICONTROL 连接]**。 _元广告帐户_&#x200B;视图打开。

1. 如果出现提示，从浏览器中选择&#x200B;**[!UICONTROL 允许弹出窗口]**。

1. 选择一个或多个要连接的广告帐户，然后单击&#x200B;**[!UICONTROL 选择]**。
