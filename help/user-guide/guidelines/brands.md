...
| 区域 | 渠道 | 描述 | 最佳做法 |
| ------------------| --------- | --------- | -------- |
| 常规 | 电子邮件、Meta、横幅和显示广告 | 第二个主题行或电子邮件预览文本 | 定义整个电子邮件的总体语气/情绪保持一致（2-5条准则）。<br>_示例_： “保持友好和可接近的语气”，“避免过于正式的语言”<br><br> |
| 主题 | 电子邮件 | 用于总结电子邮件内容的引人入胜且有趣的标题 | 就语调、长度等提供具体指导（2-5条指南）。在&#x200B;_示例_&#x200B;部分中添加以前成功的主题行以获得更好的质量输出。<br>_示例_：“将主题与电子邮件正文对齐” |
| 预编译标头 | 电子邮件 | 第二个主题行或电子邮件预览文本 | 就语调、理想长度等提供具体指导（2-5条指南）。在&#x200B;_示例_&#x200B;部分中添加以前成功的预标头，以获得更好的质量输出。<br>_示例_：“限制为60-80个字符” |
| 标题 | 电子邮件、Meta、横幅和显示广告、LinkedIn | 引起读者注意的标题或短语 | 就语调、理想长度等提供具体指导（2-5条指南）。在&#x200B;_示例_&#x200B;部分添加以前成功的标题，以获得更好的输出质量。<br>_示例_：“使用强有力语句吸引注意力” |
| 副标题 | 电子邮件、横幅和显示广告 | 吸引读者注意的第二或第三个标题或短语 | 提供具体指导（2-5条指南），定义语气、理想长度等。在&#x200B;_示例_&#x200B;部分添加以前成功的子标题，以获得更好的输出质量。<br>_示例_：“使用强有力语句吸引注意力” |
| 描述 | LinkedIn | 描述性短语定义总体语调情感 | 就语调、理想长度等提供具体指导（2-5条指南）。在&#x200B;_示例_&#x200B;部分中添加之前成功的描述以提高输出质量。<br>_示例_：“保持友好和亲切的语调” |
| 正文 | 电子邮件、Meta、横幅和显示广告、LinkedIn | 包括消息、链接和图像的营销内容 | 就语调、理想长度等提供具体指导（2-5条指南）。将以前成功的副本添加到&#x200B;_示例_&#x200B;部分，以获得更好的输出质量。<br>_示例_： “限制为80-100个字符”，“避免使用过多的首字母缩略词” |
| 图像上文本 | Meta， LinkedIn | 有关图像顶部显示的文本色调、理想长度等的特定指导 | 在语调、理想长度等方面提供具体指导（1-2个句子）。将以前成功的文本添加到&#x200B;_示例_&#x200B;部分以获得更好的质量输出。<br>_示例_：“关注当下” |
| call-to-action (CTA) | 电子邮件、Meta、横幅和显示广告 | (Call to action)向读者发出的激发响应的指令。 通常为一个或两个单词，如`Get started` | 就语调、理想长度等提供具体指导（2-5条指南）。将以前成功的CTA添加到&#x200B;_示例_&#x200B;部分以获得更好的质量输出。<br>_示例_：“不要使用结束标点” |
