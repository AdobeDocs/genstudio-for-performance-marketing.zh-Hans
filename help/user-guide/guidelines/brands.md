...
| 区域 | 渠道 | 描述 | 最佳实践 |
| ------------------| --------- | --------- | -------- |
| 常规 | 电子邮件、元数据、显示广告 | 第二个主题行或电子邮件预览文本 | 定义总体语调/情绪以使其在整个电子邮件中保持一致（2-5准则）。<br>_示例_：“保持友好和亲切的语调”、“避免过于正式的语言”<br><br> |
...
| 标题 | 电子邮件、元数据、显示广告、LinkedIn | 引起读者注意的标题或短语 | 就语调、理想长度等提供具体指导（2-5条指南）。 在&#x200B;_示例_&#x200B;部分添加以前成功的标题，以获得更好的输出质量。<br>_示例_：“使用强式语句吸引注意力” |
| 副标题 | 电子邮件、显示广告 | 吸引读者注意的第二或第三个标题或短语 | 提供具体指导（2-5条指南），定义语气、理想长度等。 在&#x200B;_示例_&#x200B;部分添加以前成功的子标题，以获得更好的输出质量。<br>_示例_：“使用强式语句吸引注意力” |
| 描述 | LinkedIn | 描述性短语定义总体语调情感 | 就语调、理想长度等提供具体指导（2-5条指南）。 在&#x200B;_示例_&#x200B;部分中添加以前成功的描述以提高输出质量。<br>_示例_：“保持友好和亲切的语调” |
| 正文 | 电子邮件、元数据、显示广告、LinkedIn | 包括消息、链接和图像的营销内容 | 就语调、理想长度等提供具体指导（2-5条指南）。 将以前成功的副本添加到&#x200B;_示例_&#x200B;部分以获得更好的质量输出。<br>_示例_：“限制为80-100个字符”、“避免使用过多的首字母缩略词” |
| 图像上文本 | Meta， LinkedIn | 对语调、理想长度等的具体指导。 显示在图像顶部的文本 | 在语调、理想长度等方面提供具体指导（1-2个句子）。 将以前成功的文本添加到&#x200B;_示例_&#x200B;部分以获得更好的质量输出。<br>_示例_：“关注当下” |
| 行动号召(CTA) | 电子邮件、元数据、显示广告 | （行动号召）给阅读器的指令，它会激发响应。 通常为一个或两个单词，如`Get started` | 就语调、理想长度等提供具体指导（2-5条指南）。 将以前成功的CTA添加到&#x200B;_示例_&#x200B;部分以获得更好的质量输出。<br>_示例_：“不使用结尾标点” |
