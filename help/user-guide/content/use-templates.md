...
接下来，[使用占位符自定义您的模板](/help/user-guide/content/customize-template.md)，以指示GenStudio for Performance Marketing应在何处为您生成内容。 [将模板](#add-a-template)添加到[!DNL Content]存储库并验证模板。 使用代码编辑器进行任何较小的更正。
