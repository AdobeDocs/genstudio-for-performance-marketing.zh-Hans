...
GenStudio for Performance Marketing可扩展应用程序的开发人员使用标准Adobe CX企业版应用程序开发工具集框架来开发和部署自定义应用程序或加载项。 [Adobe App Builder](https://developer.adobe.com/app-builder/)是此开发工具集的中心。
