...
如果您是Adobe社区的一员，并且希望创建文章或提交重大更改，请在&#x200B;_问题_&#x200B;选项卡上提交问题以开始与文档团队的对话。 一旦您和作者就计划达成一致，即可一起构建和放置内容。

### Adobe员工做出的主要更改

如果您是Adobe产品团队的技术文档撰稿人、项目经理或开发人员，并且您的工作就是撰写或创作技术文章，请使用位于`https://git.corp.adobe.com/AdobeDocs`的专用存储库。
...
- [Markdown基础知识](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax)
